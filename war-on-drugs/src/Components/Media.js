...
function Media({}) {
    ...
    return (
        <div>
         ...
         <iframe width="1019" height="573" src="https://www.youtube.com/embed/pCyYSQLAEFk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
    );
}
